...
#define STRING_CONFIG_H_AUTHOR "(RenShen, ORTUR Obsidian config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ORTUR Obsidian"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 5*16, 5*16, 25*16, 24*16 }
