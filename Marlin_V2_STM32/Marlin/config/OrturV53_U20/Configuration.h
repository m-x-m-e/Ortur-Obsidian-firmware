...
#define STRING_CONFIG_H_AUTHOR "(RenShen, Alfawise U20 config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ORTUR_V53
#endif
 ...
 */
//#define PSU_CONTROL
#define PSU_NAME "Ortur Power Control Unit"


#if ENABLED(PSU_CONTROL)
  #define PSU_ACTIVE_HIGH true     // Set 'false' for ATX, 'true' for X-Box

  #define ORTUR_PCU                // Ortur Power Control Unit
...
#define TEMP_WINDOW            1.5  // (°C) Temperature proximity for the "temperature reached" timer
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 5*16, 5*16, 25*16, 5.78*16 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 200, 20, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 2250, 100, 10000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -21, -27, 0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEVELING_FADE_HEIGHT  3.0
...
#define PREHEAT_5_TEMP_HOTEND 245
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MAX_POS-100), 20 }
