...
#define STRING_CONFIG_H_AUTHOR "(RenShen, Alfawise U20Plus config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Alfawise U20Plus"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 200, 25, 50 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MAX_POS-100), 2 }
