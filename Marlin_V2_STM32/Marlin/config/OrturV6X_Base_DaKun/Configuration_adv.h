 ...
 */
  ...
  #define BED_CHECK_INTERVAL 500 // ms between checks in bang-bang control
    ...
    #define BED_HYSTERESIS TEMP_BED_HYSTERESIS // Only disable heating if T>target+BED_HYSTERESIS and enable heating if T>target-BED_HYSTERESIS
  #endif
#endif
...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_MIN_TRIGGER   (EXTRUDE_MINTEMP)     // (°C) Minimum temperature to enable hotend protection
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_STOP "M220S100\nM221S100\nG28XYO\nG0X5Y" STRINGIFY(Y_MAX_POS) "\nM18\nM300S440P200\nM300S660P250\nM300S880P300\n"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
...
//
#define SAVED_POSITIONS 6         // Each saved position slot costs 12 bytes
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE       8  // (mm/s) feedrate to purge before unload

  #define PAUSE_PARK_NOZZLE_TIMEOUT      (10*60)  // (seconds) Time limit before the nozzle is turned off for safety.
