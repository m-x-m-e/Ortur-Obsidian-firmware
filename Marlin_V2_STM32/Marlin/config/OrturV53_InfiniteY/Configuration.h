...
#define STRING_CONFIG_H_AUTHOR "(RenShen, Infinite Y config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Infinite Y"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 5*16, 1.65*16, 25*16, 5.78*16 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 120, 20, 25 }
