...
#define ANALOG_OK(PN) ((PN) >= 0 && (PN) < NUM_DIGITAL_PINS && (PN) >=  NUM_ANALOG_FIRST)
...
#endif
#if PIN_EXISTS(LCD_CS)
  REPORT_NAME_DIGITAL(__LINE__, LCD_CS_PIN)
#endif
#if PIN_EXISTS(LCD_DC)
  REPORT_NAME_DIGITAL(__LINE__, LCD_DC_PIN)
#endif
#if PIN_EXISTS(LCD_MOSI)
  REPORT_NAME_DIGITAL(__LINE__, LCD_MOSI_PIN)
#endif
#if PIN_EXISTS(LCD_MISO)
  REPORT_NAME_DIGITAL(__LINE__, LCD_MISO_PIN)
#endif
#if PIN_EXISTS(LCD_SCK)
  REPORT_NAME_DIGITAL(__LINE__, LCD_SCK_PIN)
#endif
...
#endif
#if PIN_EXISTS(SERIAL_RX)
  REPORT_NAME_DIGITAL(__LINE__, SERIAL_RX_PIN)
#endif
#if PIN_EXISTS(SERIAL_TX)
  REPORT_NAME_DIGITAL(__LINE__, SERIAL_TX_PIN)
#endif

#if PIN_EXISTS(SERIAL2_RX)
  REPORT_NAME_DIGITAL(__LINE__, SERIAL2_RX_PIN)
#endif
#if PIN_EXISTS(SERIAL2_TX)
  REPORT_NAME_DIGITAL(__LINE__, SERIAL2_TX_PIN)
#endif
