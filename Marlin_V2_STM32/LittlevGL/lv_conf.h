...
#define LV_MEM_CUSTOM      0                /*1: use custom malloc/free, 0: use the built-in lv_mem_alloc/lv_mem_free*/
	#if LV_MEM_CUSTOM == 0
    #define LV_MEM_SIZE    (19U * 1024U)        /*Size memory used by `lv_mem_alloc` in bytes (>= 2kB)*/
...
//#define USE_SPI_FLASH_FONT

#define SCREEN_SIZE         28
//#define SCREEN_SIZE         35
...
#define LV_REFR_PERIOD      (1000/24)    /*Screen refresh period in milliseconds*/
...
#if ORTUR_BOARD >= 60
#define LV_VDB_SIZE         (LV_HOR_RES * 6)
#elif ORTUR_BOARD >= 50
#define LV_VDB_SIZE         (LV_HOR_RES * 16)
#endif
...
#define LV_VDB_ATTRIBUTE    __attribute__((aligned(4)))
...
#define LV_COLOR_TRANSP    LV_COLOR_HEX(0xAAAAAA) /*Images pixels with this color will not be drawn (with chroma keying)*/
...
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (getCurrentMillis())     /*Expression evaluating to current systime in ms*/
...
#define USE_LV_FONT_DEJAVU_30              2
 ...
 */
#if SCREEN_SIZE == 28
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(microsoft_yahei_ascii_16)\
                               LV_FONT_DECLARE(microsoft_yahei_symbol_16)\
                               LV_FONT_DECLARE(microsoft_yahei_chinese_16)

#define USE_MICROSOFT_YAHEI_SYMBOL_16     4
#define USE_MICROSOFT_YAHEI_ASCII_16      4
#define USE_MICROSOFT_YAHEI_CHINESE_16    4

#define LV_FONT_DEFAULT        &microsoft_yahei_ascii_16     /*Always set a default font from the built-in fonts*/

#elif SCREEN_SIZE == 35

#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(microsoft_yahei_ascii_20)\
                               LV_FONT_DECLARE(microsoft_yahei_symbol_20)\
                               LV_FONT_DECLARE(microsoft_yahei_chinese_20)

#define USE_MICROSOFT_YAHEI_SYMBOL_20     8
#define USE_MICROSOFT_YAHEI_ASCII_20      8
#define USE_MICROSOFT_YAHEI_CHINESE_20    8

#define LV_FONT_DEFAULT        &microsoft_yahei_ascii_20     /*Always set a default font from the built-in fonts*/
